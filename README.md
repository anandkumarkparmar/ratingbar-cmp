...
<table>
  ...
  <tr>
    <td><img src="assets/demos/android-demo.gif" width="200"/></td>
    <td><img src="assets/demos/desktop-demo.gif" width="550"/></td>
  </tr>
</table>
...
dependencies {
    implementation("com.github.anandkumarkparmar:ratingbar-cmp:0.3.0")
}
```
